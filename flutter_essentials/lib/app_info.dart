...
class AppInfo {
  ...
  static Future<String> get packageName async {
    final String version =
        await SHARED_CHANNEL.invokeMethod('${_methodPrefix}packageName');
    return version;
  }
  ...
  static Future<String> get versionString async {
    final String version =
        await SHARED_CHANNEL.invokeMethod('${_methodPrefix}versionString');
    return version;
  }

  static Future<String> get buildString async {
    final String version =
        await SHARED_CHANNEL.invokeMethod('${_methodPrefix}buildString');
    return version;
  }

  static Future showSettingsUI() async {
    await SHARED_CHANNEL.invokeMethod('${_methodPrefix}showSettingsUI');
  }
}
